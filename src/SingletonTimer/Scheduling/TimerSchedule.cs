...
namespace SingletonTimer.Schedulling
{
    /// <summary>
    /// A timer scheduling strategy used with <see cref="SingletonTimerTriggerAttribute"/> for schedule
    ...
    public abstract class TimerSchedule
    {
        ...
        internal static TimerSchedule Create(SingletonTimerTriggerAttribute attribute, INameResolver nameResolver, ILogger logger)
        {
