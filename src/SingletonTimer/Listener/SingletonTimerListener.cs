...
namespace SingletonTimer.Listeners
{
    [Singleton(Mode = SingletonMode.Listener)]
    internal sealed partial class SingletonTimerListener : IListener
    {
        ...
        private readonly SingletonTimerTriggerAttribute _attribute;
        ...
        public SingletonTimerListener(SingletonTimerTriggerAttribute attribute, TimerSchedule schedule, string timerName, SingletonTimersOptions options, ITriggeredFunctionExecutor executor,
        ...
        public async Task StartAsync(CancellationToken cancellationToken)
        {
            ...
            string nextOccurrences = FormatNextOccurrences(_schedule, 5);
        ...
        internal async Task InvokeJobFunction(DateTime invocationTime, bool isPastDue = false, bool runOnStartup = false, DateTime? originalSchedule = null)
        {
            try
            {
                ...
                TimerInfo timerInfo = new TimerInfo(timerInfoStatus, isPastDue);
        ...
        // pezhen copy from https://github.com/Azure/azure-webjobs-sdk-extensions/blob/8f97c7a7f1514ca5b7b467edc3b5cdbaeba2b350/src/WebJobs.Extensions/Extensions/Timers/TimerInfo.cs
        internal static string FormatNextOccurrences(TimerSchedule schedule, int count, DateTime? now = null)
        {
            ...
            const string DateTimeFormat = "MM'/'dd'/'yyyy HH':'mm':'ssK";
