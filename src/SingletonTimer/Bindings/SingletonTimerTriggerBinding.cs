...
using SingletonTimer.Listeners;
using SingletonTimer.Schedulling;

namespace SingletonTimer.Bindings
{
    [SupportsRetry]
    internal class SingletonTimerTriggerBinding : ITriggerBinding
    {
        ...
        public SingletonTimerTriggerBinding(ParameterInfo parameter, SingletonTimerTriggerAttribute attribute, TimerSchedule schedule, SingletonTimersOptions options, ILogger logger, ScheduleMonitor scheduleMonitor)
        {
        ...
        {
            this._logger.LogDebug("!!!!!!!!!!!!!!!!!!!! BindAsync start ");
        ...
        public Task<IListener> CreateListenerAsync(ListenerFactoryContext context)
        {
            ...
            return Task.FromResult<IListener>(new SingletonTimerListener(_attribute, _schedule, _timerName, _options, context.Executor, _logger, _scheduleMonitor, context.Descriptor?.LogName));
        }
